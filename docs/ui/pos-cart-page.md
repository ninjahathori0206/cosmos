...
- **Configured lab line footer (Jun 2026):** when LAB line has `lens_bundle`, show package row + prices and **Edit lenses & power →**; `power_mode === 'later'` adds **Power · after payment** and **Upload prescription after payment** footer. Lines **without** bundle keep **Lens · pending setup** and **Select lenses →**.
