...
/** ERP module switcher — keys, labels, icons, routes (sidebar footer + meta). */
const COSMOS_MODULES_CATALOG = [
  { key: 'foundry', label: 'Foundry', shortLabel: 'Foundry', icon: '🔩', href: '/foundry/dashboard' },
  { key: 'finance', label: 'Finance', shortLabel: 'Finance', icon: '💰', href: '/finance/dashboard' },
