...
BEGIN
  INSERT INTO dbo.pos_lab_transitions (from_status, to_status, actor_role, requires_note) VALUES
    ...
    (N'SENT_TO_LAB',         N'LAB_PROCESSING',         N'lab_manager',     0),
    (N'LAB_PROCESSING',      N'QC_PASS',                N'qc_team',         0),
    (N'LAB_PROCESSING',      N'QC_FAIL_LAB',            N'qc_team',         1),
    (N'QC_FAIL_LAB',         N'LAB_PROCESSING',         N'lab_manager',     0),
    ...
    (N'RECEIVED_AT_STORE',   N'CUSTOMER_NOTIFIED',     N'store_staff',     0),
    (N'CUSTOMER_NOTIFIED',   N'READY_FOR_DELIVERY',    N'store_staff',     0),
