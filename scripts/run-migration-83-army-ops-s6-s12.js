/**
 * Migration 83 — Army HR ops S6–S12
 */
...
async function main() {
  ...
  const migFile = path.join(__dirname, '..', 'sql', 'migrations', '83_army_ops_s6_s12.sql');
  ...
  try {
    ...
    console.log('[migration-83] OK — Army ops tables S6–S12 deployed.');
  } finally {
    await pool.close();
  }
}
